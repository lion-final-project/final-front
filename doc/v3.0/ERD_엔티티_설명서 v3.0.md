...
- `idx_order_products_order_id`: order_id
- `idx_order_products_product_id`: product_id
...
- `idx_approval_documents_store`: store_id
- `idx_approval_documents_rider`: rider_id
- `idx_approval_documents_verified`: is_verified
...
- `idx_store_approvals_store_created`: (store_id, created_at)
- `idx_store_approvals_status`: status
...
- `reporter_id`: 신고자 ID(user FK)
- `reporter_type`: 신고 유형 (STORE, RIDER, CUSTOMER)
- `target_id`: 피신고자 ID(user FK)
