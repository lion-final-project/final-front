...
const KAKAO_OAUTH_AUTHORIZE_URL =
  import.meta.env.VITE_KAKAO_OAUTH_AUTHORIZE_URL ||
  `${API_BASE_URL}/oauth2/authorization/kakao`;
const NAVER_OAUTH_AUTHORIZE_URL =
  import.meta.env.VITE_NAVER_OAUTH_AUTHORIZE_URL ||
...
const AuthModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (mode === "social-extra") {
      if (!socialSignupState)
        return alert("소셜 가입 정보가 만료되었습니다. 다시 로그인해 주세요.");
      if (!name || !phone)
        return alert("이름과 휴대폰 번호를 모두 입력해주세요.");
      if (!isPhoneVerified) return alert("휴대폰 인증이 필요합니다.");
    ...
    if (mode === "forgot-password") {
      ...
      try {
        ...
        alert(
          "비밀번호 재설정 안내 메일을 발송했습니다. 이메일을 확인해주세요.",
        );
        setMode("login");
      } catch (err) {
    ...
    >
      <div
        ...
        style={{
          ...
          width: "90%",
          maxWidth:
            mode === "signup" || mode === "social-extra" ? "480px" : "400px",
          borderRadius: "28px",
          padding: "40px",
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <h2
            style={{
              fontSize:
                mode === "signup" || mode === "social-extra" ? "24px" : "28px",
              fontWeight: "800",
              marginBottom: "8px",
              color: "#1e293b",
            }}
          ...
          <p style={{ color: "#64748b", fontSize: "15px" }}>
            {mode === "login"
              ? "로그인하고 우리 동네 소식을 확인하세요"
              : mode === "forgot-password"
                ? "가입하신 이메일 주소를 입력해주세요"
                : "단 1분만에 가입하고 신선함을 배달받으세요"}
          </p>
        </div>
        ...
        >
              ...
              >
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  ...
                  <button
                    ...
                    disabled={isEmailChecked || apiLoading}
                    style={{
                      padding: "0 16px",
                      borderRadius: "12px",
                      border: "none",
                      background: isEmailChecked ? "#10b981" : "#334155",
                      color: "white",
                      fontWeight: "700",
                      fontSize: "13px",
                      cursor: "pointer",
          ...
          <button
            ...
            style={{
              marginTop: "10px",
              padding: "16px",
              backgroundColor: apiLoading ? "#94a3b8" : "#10b981",
              color: "white",
              border: "none",
              borderRadius: "16px",
              fontWeight: "800",
