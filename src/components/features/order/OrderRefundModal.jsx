                ...
                >
                    <div>
                        ...
                        >
                            ...
                            <option value="damaged_product">상품 파손</option>
                            <option value="missing_product">누락된 상품</option>
                    ...
                    {reason === "other" && (
                        <div>
                            ...
                            <textarea
                                ...
                                disabled={isProcessing}
                                placeholder="환불 사유를 자세히 입력해주세요. (부적절한 언어 사용 시 제재될 수 있습니다.)"
                                style={{
                                    width: "100%",
                                    height: "100px",
                                    padding: "12px",
                    ...
                    >
                        • 환불 요청 확인 후 최대 3영업일 내에 처리됩니다.
                        <br />
                        • 상품 회수가 필요한 경우 고객님께 개별 연락이 갈 수 있습니다.
                    </div>
