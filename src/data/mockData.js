...
export const stores = [
  { id: 1, name: '성수동 햇살 청과', category: 'fruit', rate: 4.8, reviews: 128, time: '15분 내 도착', img: 'https://images.unsplash.com/photo-1488459711615-de61859233bd?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('햇살 청과'), isOpen: true, distance: 1.2, status: '정상' },
  { id: 2, name: '망원시장 싱싱 정육', category: 'butcher', rate: 4.9, reviews: 256, time: '20분 내 도착', img: 'https://images.unsplash.com/photo-1607623273573-599d75b03519?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('싱싱 정육'), isOpen: true, distance: 2.8, status: '정상' },
  { id: 3, name: '연남동 바다 수산', category: 'fish', rate: 4.7, reviews: 89, time: '25분 내 도착', img: 'https://images.unsplash.com/photo-1615141982883-c7ad0e69fd62?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('바다 수산'), isOpen: true, distance: 0.8, status: '정상' },
  { id: 4, name: '합정동 소문난 마트', category: 'mart', rate: 4.6, reviews: 154, time: '12분 내 도착', img: 'https://images.unsplash.com/photo-1578916171728-46686eac8d1f?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('소문난 마트'), isOpen: false, distance: 3.5, status: '정상' },
  { id: 13, name: '성심당 마포점', category: 'bakery', rate: 4.9, reviews: 1024, time: '40분 내 도착', img: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=400&q=80', products: generateProducts('성심당'), isOpen: true, distance: 4.2, status: '정상' },
  { id: 6, name: '서교동 로컬 반찬', category: 'banchan', rate: 4.8, reviews: 75, time: '18분 내 도착', img: 'https://images.unsplash.com/photo-1550989460-0adf9ea622e2?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('로컬 반찬'), isOpen: true, distance: 1.5, status: '정상' },
  { id: 7, name: '우리동네 철물점', category: 'hardware', rate: 4.5, reviews: 42, time: '30분 내 도착', img: 'https://images.unsplash.com/photo-1581235720704-06d3acfcb36f?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80', products: generateProducts('철물점'), isOpen: false, distance: 2.2, status: '중지됨' },
  { id: 16, name: '행복한 수퍼마켓', category: 'mart', rate: 4.6, reviews: 85, time: '12분 내 도착', img: 'https://images.unsplash.com/photo-1550583724-125581f77833?auto=format&fit=crop&w=400&q=80', products: generateProducts('행복한 수퍼'), isOpen: true, distance: 0.5, status: '정상' },
  { id: 20, name: '바삭이네 분식', category: 'snack', rate: 4.7, reviews: 450, time: '30분 내 도착', img: 'https://images.unsplash.com/photo-1585117822944-77e87aed24fe?auto=format&fit=crop&w=400&q=80', products: generateProducts('바삭이네'), isOpen: true, distance: 3.1, status: '정상' },
  { id: 25, name: '비활성 테스트 상점', category: 'mart', rate: 4.0, reviews: 10, time: '20분 내 도착', img: 'https://images.unsplash.com/photo-1534723328310-e82dad3ee43f?auto=format&fit=crop&w=400&q=80', products: generateProducts('테스트'), isOpen: true, distance: 1.0, status: '비활성' }
];
